...
export default function Header() {
  return (
    <div className="card p-3 md:p-4 max-w-xl flex items-center justify-between">
      ...
      <button className="ml-3 md:ml-4 relative rounded-full p-2 bg-hc.soft hover:shadow-pill">
        ...
        <span className="absolute -top-1 -right-1 bg-hc.primary text-white text-[10px] px-1.5 py-0.5 rounded-full"></span>
      </button>
    </div>
  );
}
